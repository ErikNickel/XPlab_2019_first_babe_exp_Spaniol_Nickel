...
const intro = babeViews.intro({
    ...
    text:   `
            This is an mental rotation experiment.
            `,
...
const instructions = babeViews.instructions({
    ...
    text:  'Just check if the two shapes are the same and press the according button. :] ',
...
// });
const keyPress_5S= babeViews.keyPress({
  trials: trial_info.keyPress.length,
  name: 'keyPress_5S',
  trial_type: 'keyPress_5S',
